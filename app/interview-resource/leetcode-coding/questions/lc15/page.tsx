  ...
  return (
    <section>
      ...
      <div className="prose dark:prose-invert max-w-none mb-8">
        ...
        <p>You are given an array of k linked-lists <code>lists</code>, each linked-list is sorted in ascending order.</p>
...
Output: []
      ...
      <div className="prose dark:prose-invert max-w-none">
        <h2>My Solution</h2>
        <p>I used a divide-and-conquer approach to merge k sorted lists:</p>
